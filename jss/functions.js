...
! function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        execPlugin: function(i, n) {
            ...
            let t, s = !1;
            n.trigger && !scwEvents[n.trigger] ? t = setInterval(function i() { return Function("return " + n.pluginfn)() && (e(window).trigger(n.trigger), scwEvents[n.trigger] = !0, clearInterval(t)), i }(), 1e3) : s = !0, n.execfn && (n.trigger && !s ? e(window).on(n.trigger, function() { SEMICOLON.initialize.execFunc(n.execfn, window, i) }) : SEMICOLON.initialize.execFunc(n.execfn, window, i)), n.class && o.addClass(n.class)
        },
        jsLinking: function(i, n) {
            ...
            let t, s = Function("return " + n.pluginfn)(),
                a = "js/",
                l = !1;
            "undefined" != typeof scwJsPath && (a = scwJsPath + "/"), "undefined" != typeof scwDisableJsAJAX && !0 === scwDisableJsAJAX && (l = !0), t = /^(f|ht)tps?:\/\//i.test(window.decodeURIComponent(n.file)) ? n.file : a + n.file, s ? SEMICOLON.initialize.execPlugin(i, n) : l ? console.log(n.error) : e.ajax({ url: t, dataType: "script", cache: !0, crossDomain: !0, timeout: 5e3 }).done(function() { SEMICOLON.initialize.execPlugin(i, n) }).fail(function() { console.log(n.error) })
        },
        ...
        menuInvert: function(i) {
            ...
            n.children().css({ display: "block" }), n.css({ display: "block" }), n.each(function(i, n) {
                let t = e(n),
                    s = t.offset(),
                    a = t.width();
                E - (a + s.left) < 0 && t.addClass("menu-pos-invert")
        ...
        menufunctions: function() {
            ...
            l = Number(l), i = n.children(".sub-menu-trigger"), o.hasClass("device-xl") || o.hasClass("device-lg") ? (setTimeout(function() { y.length > 0 && y.css({ height: u.outerHeight() }), SEMICOLON.header.includeOffset() }, 1e3), M.find(a).css({ display: "" })) : c.css({ "margin-top": "" }), o.hasClass("overlay-menu") && M.hasClass("on-click") && (o.hasClass("device-xl") || o.hasClass("device-lg")) ? t.off("click").on("click", function(i) {
                let n = e(this);
            ...
            }) : o.hasClass("side-header") && M.hasClass("on-click") || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs") ? (i.removeClass("icon-rotate-90"), e(".menu-item").find(a).filter(":not(:animated)").stop(!0, !0).slideUp(l, function() { o.toggleClass("primary-menu-open", !1) }), (i = i.add(t.filter('[href^="#"]'))).off("click").on("click", function(i) {
                let n = e(this);
            ...
            })) : (o.hasClass("overlay-menu") || o.hasClass("side-header")) && (o.hasClass("device-xl") || o.hasClass("device-lg")) ? (M.find(a).stop(!0, !0).slideUp(l), e(".menu-item").hover(function(i) { e(this).children(s).stop(!0, !0).slideDown(l) }, function() { e(this).children(s).stop(!0, !0).slideUp(l) })) : M.hasClass("on-click") && t.off("click").on("click", function(i) {
                let n = e(this);
            ...
            }), (e(".top-links").hasClass("on-click") || o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) && e(".top-links-item:has(.top-links-sub-menu,.top-links-section) > a").on("click", function(i) { e(this).parents("li").siblings().find(".top-links-sub-menu,.top-links-section").removeClass("d-block"), e(this).parent("li").children(".top-links-sub-menu,.top-links-section").toggleClass("d-block"), i.preventDefault() }), SEMICOLON.header.menuInvert(e(".top-links-section")), e("#primary-menu-trigger").off("click").on("click", function() { return (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) && (M.find(".mobile-primary-menu").length > 0 ? (e(".primary-menu:not(.mobile-menu-off-canvas) .mobile-primary-menu").stop(!0, !0).slideToggle(l), e(".primary-menu.mobile-menu-off-canvas .mobile-primary-menu").toggleClass("d-block")) : (e(".primary-menu:not(.mobile-menu-off-canvas) .menu-container").stop(!0, !0).slideToggle(l), e(".primary-menu.mobile-menu-off-canvas .menu-container").toggleClass("d-block"))), o.toggleClass("primary-menu-open"), !1 }), e(".menu-container:not(.mobile-primary-menu)").css({ display: "" }), (o.hasClass("device-xl") || o.hasClass("device-lg")) && M.find(".mobile-primary-menu").removeClass("d-block")
        },
        ...
        menuItemsSpacing: function(e) {
            let i = b;
            o.hasClass("side-header") || o.hasClass("overlay-menu") || (M.hasClass("menu-spacing-margin") ? "" == e ? i.css({ "margin-top": "", "margin-bottom": "" }) : i.css({ "margin-top": Number(e), "margin-bottom": Number(e) }) : "" == e ? i.css({ "padding-top": "", "padding-bottom": "" }) : i.css({ "padding-top": Number(e), "padding-bottom": Number(e) }))
        },
        ...
        topsearch: function() {
            ...
            e("#top-search-trigger").off("click").on("click", function(e) { clearTimeout(n), o.toggleClass("top-search-open"), G.toggleClass("top-cart-open", !1), (o.hasClass("device-md") || o.hasClass("device-sm") || o.hasClass("device-xs")) && (M.filter(":not(.mobile-menu-off-canvas)").find(".menu-container").slideUp(200), M.filter(".mobile-menu-off-canvas").find(".menu-container").toggleClass("d-block", !1)), o.hasClass("top-search-open") ? i.toggleClass("position-relative", !0) : n = setTimeout(function() { i.toggleClass("position-relative", !1) }, 750), o.toggleClass("primary-menu-open", !1), $.toggleClass("page-menu-open", !1), o.hasClass("top-search-open") && Y.find("input").focus(), e.stopPropagation(), e.preventDefault() })
        },
        topcart: function() {
        ...
        sliderParallax: function() {
            ...
            let e, i, n = SEMICOLON.slider.sliderParallaxOffset(),
                a = Q.outerHeight();
            t = window.pageXOffset, s = window.pageYOffset, !o.hasClass("device-xl") && !o.hasClass("device-lg") || SEMICOLON.isMobile.any() ? Q.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ie), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, Z), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (a + n + 50 > s ? (Q.addClass("slider-parallax-visible").removeClass("slider-parallax-invisible"), s > n ? Q.find(".slider-inner").length > 0 ? (e = -.4 * (s - n), i = -.15 * (s - n), SEMICOLON.slider.sliderParallaxSet(0, e, ie), SEMICOLON.slider.sliderParallaxSet(0, i, ee)) : (e = (s - n) / 1.5, i = (s - n) / 7, SEMICOLON.slider.sliderParallaxSet(0, e, Z), SEMICOLON.slider.sliderParallaxSet(0, i, ee)) : Q.find(".slider-inner").length > 0 ? (SEMICOLON.slider.sliderParallaxSet(0, 0, ie), SEMICOLON.slider.sliderParallaxSet(0, 0, ee)) : (SEMICOLON.slider.sliderParallaxSet(0, 0, Z), SEMICOLON.slider.sliderParallaxSet(0, 0, ee))) : Q.addClass("slider-parallax-invisible").removeClass("slider-parallax-visible"), requestAnimationFrame(function() { SEMICOLON.slider.sliderParallax(), SEMICOLON.slider.sliderElementsFade() }))
        },
        ...
        notifications: function(e) {
            let i = { element: e, default: !1, file: "plugins.notify.js", error: "plugins.notify.js: Plugin could not be loaded", execfn: "SEMICOLON_notificationInit", pluginfn: 'typeof toastr !== "undefined"', trigger: "pluginNotifyReady", class: "has-plugin-toastr" };
            SEMICOLON.initialize.functions(i)
        },
        ...
        extras: function() { e(window).on("pluginBootstrapReady", function() { e().tooltip ? e('[data-toggle="tooltip"]').tooltip({ container: "body" }) : console.log("extras: Bootstrap Tooltip not defined."), e().popover ? e("[data-toggle=popover]").popover() : console.log("extras: Bootstrap Popover not defined.") }), e(".style-msg").on("click", ".close", function(i) { e(this).parents(".style-msg").slideUp(), i.preventDefault() }), e("#page-menu-trigger").off("click").on("click", function() { return o.toggleClass("top-search-open", !1), $.toggleClass("page-menu-open"), !1 }), $.find("nav").off("click").on("click", function(e) { o.toggleClass("top-search-open", !1), G.toggleClass("top-cart-open", !1) }), SEMICOLON.isMobile.any() && o.addClass("device-touch") }
    }, SEMICOLON.isMobile = { Android: function() { return navigator.userAgent.match(/Android/i) }, BlackBerry: function() { return navigator.userAgent.match(/BlackBerry/i) }, iOS: function() { return navigator.userAgent.match(/iPhone|iPad|iPod/i) }, Opera: function() { return navigator.userAgent.match(/Opera Mini/i) }, Windows: function() { return navigator.userAgent.match(/IEMobile/i) }, any: function() { return SEMICOLON.isMobile.Android() || SEMICOLON.isMobile.BlackBerry() || SEMICOLON.isMobile.iOS() || SEMICOLON.isMobile.Opera() || SEMICOLON.isMobile.Windows() } }, SEMICOLON.customization = { onReady: function() {}, onLoad: function() {}, onResize: function() {} }, SEMICOLON.documentOnResize = { init: function() { SEMICOLON.header.menufunctions(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.stickyMenu(), SEMICOLON.initialize.dataResponsiveHeights(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.slider.sliderDimensions(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.customization.onResize(), E = l.width(), e(window).trigger("scwWindowResize") } }, SEMICOLON.documentOnReady = {
        init: function() {
            SEMICOLON.initialize.init(), SEMICOLON.header.init(), (W.length > 0 || U.length > 0) && SEMICOLON.slider.init(), V.length > 0 && SEMICOLON.portfolio.init(), SEMICOLON.widget.init(), SEMICOLON.documentOnReady.windowscroll(), SEMICOLON.customization.onReady(), o.hasClass("adaptive-color-scheme") && (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches && o.toggleClass("dark", !0), window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", function(e) { e.matches ? o.toggleClass("dark", !0) : o.toggleClass("dark", !1) })), o.off("click").on("click", 'a[href*="#"]', function() { l.on("beforeunload", function() { l.scrollTop(0) }) });
            let i = location.hash;
    ...
    e(document).ready(SEMICOLON.documentOnReady.init), l.on("load", SEMICOLON.documentOnLoad.init), l.on("resize", function() {
        let i = e(this);
        clearTimeout(a), a = setTimeout(function() { i.width() !== E && SEMICOLON.documentOnResize.init() }, 250)
    })
}(jQuery),
...
}(window, document, 0, 0, "ga"), ga("create", "UA-55910330-3", "auto"), ga("send", "pageview"), jQuery(document).ready(function() { jQuery(".disable-pagetransition").on("click", function() { return jQuery("body").addClass("no-transition"), jQuery(".page-transition-wrap").fadeOut(400, function() { jQuery(this).remove() }), !1 }) }),
